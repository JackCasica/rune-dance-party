export const StageCardFront = ({ limbs }) => {
  return (
    <div
      className={`card__side card__side--front bold relative flex w-full flex-col items-center rounded-xl border-8 border-black bg-white py-4 `}
    >
